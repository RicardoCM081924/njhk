layui.config({
    ...
    function rollingMessage(){
        ...
        var latestDate = result[2];
        var maxGrading = result[3];
        var maxDensity = result[4];

        $("#g1").html("当前碾压至<br><b>第"+layNum+"层级</b>");
        $("#g2").html("最新采集时间<br><b>"+latestDate+"</b>");
        $("#g3").html("当前层照片总数<br><b>"+totalNum+"张</b>");
        $("#g4").html("最大级配等级<br><b>"+maxGrading+"</b>");
        $("#g5").html("最大密度<br><b>"+maxDensity+"kg/m³</b>");
    }
